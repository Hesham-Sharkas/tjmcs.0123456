...
% This code implements Theorem 2.1, introduced in the open access article
...
N = 201;
u_hat = 2*rand(1,N,'double')-1;
v_hat = 2*rand(1,N,'double')-1;
...
RHS = 2*pi*L2_fg_real(u_hat,v_hat);
